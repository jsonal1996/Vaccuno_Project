...
/**
 * Servlet implementation class VaccinelistServ
 */
@WebServlet("/VaccinelistServ")
public class VaccinelistServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VaccinelistServ() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usename == null) {
			...
			System.out.println("In Servelet vaccine");
