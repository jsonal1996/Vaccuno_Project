	...
	<div style=" margin:auto;width: 50%; /*border: 1px solid #73AD21;*/ padding: 15px;">
		...
		<div id="list">
			<table>
				...
				%>
				<tr>
					<td><section id="sec" style="border-radius:15px;display: block;width:100%;height:auto;background-color:white;">
					<table>
						<tr>
						...
						<% String str=(String)info.get("reply");
							...
							if(str==null){ %>
							<td>
								<form action="SetQueryServ" method="post">
									<input type="hidden" name="check1" value="<%=(String)info.get("query") %>">
									
									<input style="font-weight: bold;background-color: #0093AF;color:white;font-size:20px;height:3em;" type="submit" id="sub" name="" value="Sure"  >
									<input style="font-weight: bold;background-color: #0093AF;color:white;font-size:20px;height:3em;" type="button"value="Reply"onclick="div_show()" ><br>
								</form>
							
							
							<%} 
							else{%>
							<td style="background-color:#F68380"><p style="float:left;color:red">Reply: </p><p style="float:left"><%=(String)info.get("reply") %></p> <p style="float:right"> -Answered by Dr <%=(String)info.get("by") %></td>
							<%} %>
					</tr>
					</table>
...
<div id='abc'>
	...
	<div id="popupContact">
		...
		<form action="ReplyQueryServ" id="form1" method="post" name="form">
			<img id="close" src="images/3.png" onclick="div_hide()">
			<textarea rows="4" cols="50" name="query" placeholder="Your Reply"></textarea>
