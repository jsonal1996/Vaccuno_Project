<!DOCTYPE html>
  ...
  z-index: -1;"></div>
	...
	height: 135px;">
		...
		<h1 style=" color:white;margin-left: 20px;height:10%;font-style: arial;font-weight: bold;"> Doctor Register</h1></div>
	</div>
	<div style="float: left;margin-top: 5%;margin-left: 5%; width: 40%">
		
		<form method="post" action="/VaccunoProject/Servlet_SignUpDoctor">
				<table>
				...
				<li style="list-style: none"><input style="height:38px;width:450px;font-size: 19px;font-style: arial;text-indent: 10px; border-radius: 10px"  type="text" name="location" placeholder="Location"></li><br>

				<li style="list-style: none"><input style="height:38px;width:450px;font-size: 19px;font-style: arial;text-indent: 10px; border-radius: 10px" type="text" name="licenseno" placeholder="License Number"></li><br>
				<table>
				<tr>	
					<th>
